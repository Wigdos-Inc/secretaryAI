...
class VoiceAgentClient2 {
  ...
  connect() {
    return new Promise((resolve, reject) => {
      try {
        ...
        this.socket.onopen = () => {
          console.log("[VA2] WebSocket connected, waiting for Welcome...");
        };
  ...
  handleMessage(data) {
    ...
    try {
      ...
      switch (msg.type) {
        case "Welcome":
          console.log("[VA2] Welcome received — sending Settings");
          this.sendSettings();
          break;
...
console.log("[VA2] Script loaded — minimal Deepgram-only voice agent");
